...
final class RemoveAppExtensionsOperation: ResultOperation<Void> {
    ...
    private func createAlertDialog(from targetAppBundle: ALTApplication,
        ...
        let message = firstSentence + " " + NSLocalizedString("Would you like to remove this app's extensions so they don't count towards your limit?", comment: "") + " " + "\(NSLocalizedString("Number of extensions:", comment: "")) \(extensions.count)."
